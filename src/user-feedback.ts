...
class DefaultUserFeedbackOptions implements Required<UserFeedbackOptions> {
...
export class UserFeedbackOptionsSanitizer {
  public sanitize(options?: UserFeedbackOptions): UserFeedbackOptions{
    return {
